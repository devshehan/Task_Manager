...
import 'package:expence_tracker_app/widgets/add.task.dart';
import 'package:expence_tracker_app/widgets/task_list.dart';
...
// PIE CHART
  ...
  void calculateCategoryAmounts() {
    ...
    // Loop through the expense list and calculate the total amount for each category
    for (final expence in db.expenceList) {
      switch (expence.category) {
        case Category.lowest:
          foodTotal += 10;
          break;
        case Category.low:
          travelTotal += 20;
